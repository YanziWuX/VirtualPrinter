...
; Install PostScript driver (using built-in Windows PS Class Driver)
Filename: "rundll32"; Parameters: "printui.dll,PrintUIEntry /ia /m ""Microsoft PS Class Driver"""; Flags: runhidden; StatusMsg: "正在安装打印机驱动..."

; Create port and printer
Filename: "rundll32"; Parameters: "printui.dll,PrintUIEntry /if /b ""VirtualPrinter"" /f ""%windir%\inf\ntprint.inf"" /r ""VP_Port"" /m ""Microsoft PS Class Driver"""; Flags: runhidden; StatusMsg: "正在创建打印机..."
...
Filename: "rundll32"; Parameters: "printui.dll,PrintUIEntry /dl /n ""VirtualPrinter"""; Flags: runhidden
Filename: "rundll32"; Parameters: "printui.dll,PrintUIEntry /dr /n ""VP_Port"""; Flags: runhidden
Filename: "rundll32"; Parameters: "printui.dll,PrintUIEntry /dd /m ""Microsoft PS Class Driver"""; Flags: runhidden
